...
<div className="home--discount__header">
          <img src="https://img.icons8.com/dusk/64/discount.png" alt="discount"/>
          <p>
              NƯỚC UỐNG ĐẠI HẠ GIÁ
          </p>
          </div>
      </Link>
          ...
          <div className="home--discount__footer">
              <Link to={"/discount"} >
                <button className="home--discount__button">
                  Xem tất cả 
                </button>
              </Link>
          </div>
      ...
      <div className="home--discount"> 
          ...
          <img  src="https://img.icons8.com/emoji/48/bubble-tea.png" alt="bubble-tea"/>
          <p>
              TRÀ SỮA SIÊU NGON
          </p>
          </div>
          ...
          <div className="home--discount__footer">
                ...
                <button onClick={handleClick_trs} className="home--discount__button">
                  Xem tất cả 
                </button>
      ...
      <div className="home--discount"> 
          <div onClick={handleClick_wine} className="home--discount__header">
          <img src="https://img.icons8.com/cotton/64/wine.png" alt="wine"/>
          <p>
              RƯỢU ĐẬM VỊ 
          </p>
          </div>
          ...
          <div className="home--discount__footer">
                ...
                <button onClick={handleClick_wine} className="home--discount__button">
                  Xem tất cả 
                </button>
      ...
      <div className="home--discount"> 
          <div onClick={handleClick_cafe} className="home--discount__header">
          <img  src="https://img.icons8.com/doodle/48/cafe--v3.png" alt="cafe--v3"/>
          <p>
              CAFE - ĐẬP TAN UỂ OẢI
          </p>
          </div>
          ...
          <div className="home--discount__footer">
                ...
                <button onClick={handleClick_cafe} className="home--discount__button">
                  Xem tất cả 
                </button>
      ...
      <div className="home--discount"> 
          ...
          <img  src="https://img.icons8.com/external-flaticons-lineal-color-flat-icons/64/external-smoothie-street-food-flaticons-lineal-color-flat-icons.png" alt="external-smoothie-street-food-flaticons-lineal-color-flat-icons"/>
          <p>
             SINH TỐ - CHỨA NHIỀU DƯỠNG CHẤT TỐT CHO SỨC KHỎE
          </p>
          </div>
          <div className="home--discount__content">
          <Row gutter={[15, 10]}>
          ...
          <div className="home--discount__footer">
                ...
                <button onClick={handleClick_sto} className="home--discount__button">
                  Xem tất cả 
                </button>
      ...
      <div className="home--discount"> 
          <div onClick={handleClick_juice} className="home--discount__header">
          <img  src="https://img.icons8.com/external-nawicon-outline-color-nawicon/64/external-juice-grocery-nawicon-outline-color-nawicon.png" alt="external-juice-grocery-nawicon-outline-color-nawicon"/>
          <p>
              NƯỚC ÉP - VỊ NGON NGUYÊN CHẤT TỪ TRÁI CÂY TƯƠI
          </p>
          </div>
          <div className="home--discount__content">
          <Row gutter={[15, 10]}>
          ...
          <div className="home--discount__footer">
                ...
                <button onClick={handleClick_juice} className="home--discount__button">
                  Xem tất cả 
                </button>
      ...
      <div className="home--discount"> 
          <div onClick={handleClick_soda} className="home--discount__header">
          <img  src="https://img.icons8.com/cotton/64/soda-cup.png" alt="soda-cup"/>
          <p>
              NƯỚC NGỌT CÓ GA - SẢNG KHOÁI 
          </p>
          </div>
          <div className="home--discount__content">
          <Row gutter={[15, 10]}>
          ...
          <div className="home--discount__footer">
                ...
                <button onClick={handleClick_soda} className="home--discount__button">
                  Xem tất cả 
                </button>
